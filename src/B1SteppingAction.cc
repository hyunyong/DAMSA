...
void B1SteppingAction::UserSteppingAction(const G4Step* step)
{
  ...
  */
  ...
  //const G4DynamicParticle* theParticle = tr->GetDynamicParticle();
  ...
  if (volume == fScoringVolume3) {
    ...
    /*
    auto proc_man = tr->GetDynamicParticle()->GetParticleDefinition()->GetProcessManager();
    ...
    for (G4int i = 0; i < n_proc; ++i) {
	  ...
	  //G4cout << "proName: " << proc_name << G4endl;
    ...
    */		  
    ...
    analysisManager->FillH2(4,z,x,ed);
    analysisManager->FillH2(5,z,t,ed);
    //if (t<3.) analysisManager->FillH3(0,x,y,z,ed);
    if (t<3.) analysisManager->FillH3(0,x,y,z,ed);
  }
  /*
  ...
  */ 
  ...
  if (volume == fScoringVolume4) {
    auto x = tr->GetPosition()[0]/cm;
    auto y = tr->GetPosition()[1]/cm;
    auto ed = step->GetTotalEnergyDeposit()/GeV;
    analysisManager->FillH2(16,x,y,ed);
  }
}
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
